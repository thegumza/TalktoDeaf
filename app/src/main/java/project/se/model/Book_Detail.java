...
public class Book_Detail {
    ...
    public Book_Detail(int id, String book_name, String book_description, String book_page_number, String book_price, String book_author, String book_publisher, String book_image) {
        this.id = id;
