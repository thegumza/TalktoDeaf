...
/**
 * Created by wiwat on 2/23/2015.
 */
public class GameNo5 extends Fragment{
    ...
    public static GameNo5 newInstance(int position) {
        GameNo5 f = new GameNo5();
        Bundle b = new Bundle();
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (checkedId == R.id.firstchoice) {
                    ...
                    if(shufflelist.get(0).equals(correct)){
                        editor.putString("Answer5", shufflelist.get(0));
                        editor.commit();
                    }
                    else{
                        editor.putString("Answer5", "");
                ...
                if (checkedId == R.id.secondchoice) {
                    ...
                    if(shufflelist.get(1).equals(correct)){
                        editor.putString("Answer5", shufflelist.get(1));
                        editor.commit();
                    }
                    else{
                        editor.putString("Answer5", "");
